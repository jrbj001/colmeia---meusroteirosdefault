...
BEGIN TRY
    ...
    BEGIN
        ...
        -- Buscar ID do banco_ativos para criar subáreas
        ...
        PRINT '✅ 13 áreas do sistema inseridas com sucesso';
    END
    ELSE
    BEGIN
        PRINT '⚠️ Áreas já existem, pulando inserção';
    END
...
BEGIN CATCH
    ...
    PRINT '';
    PRINT '❌ ERRO AO EXECUTAR SCRIPT 02';
