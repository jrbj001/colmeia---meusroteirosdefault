-- ============================================================
-- SEED: Usuário sandbox Ana → exibidor Eletromídia
...
DECLARE @email       NVARCHAR(255) = 'anap.larama@gmail.com';
DECLARE @nome        NVARCHAR(255) = 'Ana Paula (Sandbox Eletromídia)';
...
WHERE LOWER(u.email_st) = 'anap.larama@gmail.com';
GO
