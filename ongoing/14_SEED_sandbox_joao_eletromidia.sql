...
DECLARE @email       NVARCHAR(255) = 'jotagefreitass@gmail.com';
DECLARE @nome        NVARCHAR(255) = 'João Freitas (Sandbox Eletromídia)';
...
WHERE LOWER(u.email_st) = 'jotagefreitass@gmail.com';
GO
